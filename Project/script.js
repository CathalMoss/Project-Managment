...
// Variables
	...
	// Check for local storage and set if no storage stored 
	...
	function checkCart()
	{
		...
		//Add each "model price" to the item name field 
		if (cartNum > 0)
		{
			var txt = "";
			cart.forEach(myFunction);
 ...
 // Button for adding iPad to cart 
	function ipadAir() 
	{
	...
	// Button for adding iphone to cart 
	function iphonexs() 
	{
	...
	// Button for adding iphoneto cart
	function iphone8() 
	{
	...
	// Button for adding imac to cart 
	function imac() 
	{
	...
	// Button for adding macbook to cart
	function macbookair() 
	{
	...
	// Button for adding air pods to cart 
	function airpods() 
	{
	...
	// Button for adding iphone case to cart 
	function iphoneCase() 
	{
		...
		// Button for adding ipad case to cart 
	function ipadCase() 
	{
		...
		// Button for adding watch straps to cart 
	function watch() 
	{
